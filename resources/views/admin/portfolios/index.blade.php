...
<div class="section-header">
    ...
    <div class="ml-auto">
        <a href="{{ route('admin.portfolios.create') }}" class="btn btn-primary">Add New</a>
    </div>
</div>
                            ...
                            @forelse ($portfolios as $key => $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.portfolios.edit', $item->id) }}" class="btn btn-primary btn-xs"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('admin.portfolios.destroy', $item->id) }}" method="post" class="d-inline-block">
                                            @csrf
                                            @method('DELETE')
